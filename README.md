...
```scala
//> using dep com.softwaremill.chimp::chimp-client:0.5.0
...
```scala
//> using dep com.softwaremill.chimp::chimp-server-ox:0.5.0
...
```scala
//> using dep com.softwaremill.chimp::chimp-client-ox:0.5.0
