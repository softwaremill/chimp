...
```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-server" % "0.6.0"
```
...
```scala
//> using dep com.softwaremill.chimp::chimp-server:0.6.0
...
```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-server-zio" % "0.6.0"
```

direct-style Ox:

```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-server-ox" % "0.6.0"
```

or Pekko:

```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-server-pekko" % "0.6.0"
```
