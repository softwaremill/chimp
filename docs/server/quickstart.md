...
```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-server" % "0.5.0"
```
...
```scala
//> using dep com.softwaremill.chimp::chimp-server:0.5.0
...
```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-server-zio" % "0.5.0"
```

or direct-style Ox:

```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-server-ox" % "0.5.0"
```
