...
```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-client" % "0.5.0"
```
...
```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-client-zio" % "0.5.0"
```

or direct-style Ox:

```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-client-ox" % "0.5.0"
```
