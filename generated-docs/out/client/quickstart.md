...
```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-client" % "0.6.0"
```
...
```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-client-zio" % "0.6.0"
```

direct-style Ox:

```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-client-ox" % "0.6.0"
```

or Pekko:

```scala
libraryDependencies += "com.softwaremill.chimp" %% "chimp-client-pekko" % "0.6.0"
```
